...
from datasets import author_hin_dataset
...
def getDataLoader(config,split):
        ...
        elif data_set_name== 'DevanagariHWDataset':
            return withCollate(author_hin_dataset.AuthorHWDataset,author_hin_dataset.collate,batch_size,valid_batch_size,shuffle,shuffleValid,numDataWorkers,split,data_dir,config)
        else:
