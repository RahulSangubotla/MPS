...
def AuthorHWDataset_eval(config,instance, trainer, metrics, outDir=None, startIndex=None, lossFunc=None,toEval=None):
    return HWDataset_eval(config,instance, trainer, metrics, outDir, startIndex, lossFunc,toEval)
def AuthorNAFlinesDataset_eval(config,instance, trainer, metrics, outDir=None, startIndex=None, lossFunc=None,toEval=None):
    return HWDataset_eval(config,instance, trainer, metrics, outDir, startIndex, lossFunc,toEval)
def SynthTextDataset_eval(config,instance, trainer, metrics, outDir=None, startIndex=None, lossFunc=None,toEval=None):
    return HWDataset_eval(config,instance, trainer, metrics, outDir, startIndex, lossFunc,toEval)
...
def MixedAuthorWordDataset_eval(config,instance, trainer, metrics, outDir=None, startIndex=None, lossFunc=None,toEval=None):
    return HWDataset_eval(config,instance, trainer, metrics, outDir, startIndex, lossFunc,toEval)
def AuthorRIMESDataset_eval(config,instance, trainer, metrics, outDir=None, startIndex=None, lossFunc=None,toEval=None):
    return HWDataset_eval(config,instance, trainer, metrics, outDir, startIndex, lossFunc,toEval)
def MMDHWDataset_eval(config,instance, trainer, metrics, outDir=None, startIndex=None, lossFunc=None,toEval=None):
    return HWDataset_eval(config,instance, trainer, metrics, outDir, startIndex, lossFunc,toEval)
def AuthorRIMESLinesDataset_eval(config,instance, trainer, metrics, outDir=None, startIndex=None, lossFunc=None,toEval=None):
        return HWDataset_eval(config,instance, trainer, metrics, outDir, startIndex, lossFunc,toEval)
