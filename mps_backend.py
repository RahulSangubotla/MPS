...
def main(resume,saveDir,gpu=None,config=None,addToConfig=None, fromDataset=True, test=False, arguments=None,style_loc=None,text="This an example for mps",num_inst=10):
    np.random.seed(1234)
